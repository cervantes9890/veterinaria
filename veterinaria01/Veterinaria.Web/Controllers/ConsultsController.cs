...
namespace Veterinaria.Web.Controllers
{
    public class ConsultsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ConsultDate,Descripcion,ConsultType")] Consult consult)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ConsultDate,Descripcion,ConsultType")] Consult consult)
        {
            if (ModelState.IsValid)
            {
