...
namespace Veterinaria.Web.Controllers
{
    public class VeterinariesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Descripcion")] Veterinary veterinary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Descripcion")] Veterinary veterinary)
        {
            if (ModelState.IsValid)
            {
